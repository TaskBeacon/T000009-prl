...
| 6. **Feedback Display** | The feedback ("+10Âà?, "-10Âà?, or "Êú™ÂèçÂ∫îÔºö-10Âà?) is displayed for 0.8 seconds (`feedback_duration`). |
...
| `win_feedback` | text | "+10Âà? in white. |
| `lose_feedback` | text | "-10Âà? in white. |
| `no_response_feedback`| text | "Êú™ÂèçÂ∫îÔºö-10Âà? in white. |
